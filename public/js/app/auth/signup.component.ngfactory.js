...
export function viewFactory_SignupComponent0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_SignupComponent === null)) {
        (renderType_SignupComponent = viewUtils.createRenderComponentType('D:/TOOLS/Books/JavaScript/AngularJS/MEAN2/social-network/assets/app/auth/signup.component.html', 0, import9.ViewEncapsulation.None, styles_SignupComponent, {}));
    }
