...
export function viewFactory_MessagesComponent0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_MessagesComponent === null)) {
        (renderType_MessagesComponent = viewUtils.createRenderComponentType('D:/TOOLS/Books/JavaScript/AngularJS/MEAN2/social-network/assets/app/messages/messages.component.ts class MessagesComponent - inline template', 0, import8.ViewEncapsulation.None, styles_MessagesComponent, {}));
    }
