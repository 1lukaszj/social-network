...
export function viewFactory_SigninComponent0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_SigninComponent === null)) {
        (renderType_SigninComponent = viewUtils.createRenderComponentType('D:/TOOLS/Books/JavaScript/AngularJS/MEAN2/social-network/assets/app/auth/signin.component.html', 0, import10.ViewEncapsulation.None, styles_SigninComponent, {}));
    }
