...
export function viewFactory_LogoutComponent0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_LogoutComponent === null)) {
        (renderType_LogoutComponent = viewUtils.createRenderComponentType('D:/TOOLS/Books/JavaScript/AngularJS/MEAN2/social-network/assets/app/auth/logout.component.ts class LogoutComponent - inline template', 0, import10.ViewEncapsulation.None, styles_LogoutComponent, {}));
    }
