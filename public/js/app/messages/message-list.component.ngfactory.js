...
export function viewFactory_MessageListComponent0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_MessageListComponent === null)) {
        (renderType_MessageListComponent = viewUtils.createRenderComponentType('D:/TOOLS/Books/JavaScript/AngularJS/MEAN2/social-network/assets/app/messages/message-list.component.ts class MessageListComponent - inline template', 0, import9.ViewEncapsulation.None, styles_MessageListComponent, {}));
    }
